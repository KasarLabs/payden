...
#[component]
pub fn IconBook(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconClose(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconCopy(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconDrop(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconGithubCircle(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconGithub(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconMiden(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconPulse(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconQr(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconRefresh(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
        >
            <path d="M20.2403 13.25C19.6371 17.2594 16.1775 20.3333 12 20.3333C7.39765 20.3333 3.66669 16.6023 3.66669 12C3.66669 7.39761 7.39765 3.66666 12 3.66666C15.4172 3.66666 18.354 5.72348 19.6399 8.66666" stroke-linecap="round" stroke-linejoin="round"/><path d="M16.1667 8.66667H19.8334C20.1095 8.66667 20.3334 8.44281 20.3334 8.16667V4.5" stroke-linecap="round" stroke-linejoin="round"/>
        </Icon>
    }
}

#[component]
pub fn IconSend(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconSettings(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconTelegram(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
...
#[component]
pub fn IconTwitter(#[prop(default = ICON_BASE)] size: u32) -> impl IntoView {
    view! {
        <Icon
            width=size
            height=size
